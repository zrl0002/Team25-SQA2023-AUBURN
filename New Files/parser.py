...
def checkIfWeirdYAML(yaml_script):
    ...
    '''
    simpleLogger.info('Logging Statement: checkIfWeirdYAML') 
    return val 
...
def checkIfValidK8SYaml(path2yaml):
    ...
    Inserted logging statement
    '''
    simpleLogger.info('Logging Statement: checkIfValidK8SYaml') 
    return val2ret
...
def readYAMLAsStr( path_script ):
    ...
    Inserted logging statement
    '''
    simpleLogger.info('Logging Statement: readYAMLAsStr') 
    return yaml_as_str
...
def checkParseError( path_script ):
    ...
    Inserted logging statement
    '''
    simpleLogger.info('Logging Statement: checkParseError') 
    return flag
...
def count_initial_comment_line (filepath):
    ...
    Inserted logging statement
    '''
    simpleLogger.info('Logging Statement: count_initial_comment_line') 
...
if __name__=='__main__':
    ...
    checkIfWeirdYAML('test.yaml')
    readYAMLAsStr('test.yaml')
    checkParseError('test.yaml')
    checkIfValidK8SYaml('test.yaml')
    count_initial_comment_line('test.yaml')